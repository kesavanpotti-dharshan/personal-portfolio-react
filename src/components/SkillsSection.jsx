...
const skills = [
  ...
  { name: "ASP.NET Core MVC (Frontend)", level: 70, category: "frontend" },
  ...
  { name: "Azure", level: 80, category: "backend" },
  ...
  { name: "NuGet", level: 85, category: "tools" },
  { name: "Azure DevOps", level: 80, category: "tools" },
  { name: ".NET CLI", level: 80, category: "tools" },
];
